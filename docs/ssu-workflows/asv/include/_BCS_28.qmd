...
:::{.callout-note}
The following plate were sequenced in this run: ISTHMO S3, S4. You can access the source code for this section [here](include/_BCS_28.qmd) 
:::
...
#| echo: false
#| eval: true
system("cp files/figures/BCS_28_filt_plot_qscores.png include/figures/BCS_28_filt_plot_qscores.png")
```
...
#| echo: false
#| eval: true
samptab <- read.table("files/tables/BCS_28_read_changes.txt",
                       header = TRUE, sep = "\t")
...
samptab$per_reads_kept <- round(samptab$filtered/samptab$input, 
                                  digits = 3)
write_delim(samptab, "include/tables/BCS_28_filter_read_changes.txt", 
            delim = "\t")
```
...
{{< downloadthis include/tables/BCS_28_filter_read_changes.txt dname=BCS_28_filter_read_changes label="Download filtered read count" icon=table type=info class=data-button id=BCS_28_rc >}}
...
#| eval: true
#| echo: false
system("cp files/figures/BCS_28_plot_errorF_2.png include/figures/BCS_28_plot_errorF_2.png")
```
...
#| eval: true
#| echo: false
system("cp files/figures/BCS_28_plot_errorR_2.png include/figures/BCS_28_plot_errorR_2.png")
```
...
{{< downloadthis include/tables/BCS_28_dada_results.txt dname=BCS_28_dada_results label="Results of dada on forward & reverse reads" icon=file-earmark-fill type=info class=data-button id=BCS_28_dada >}}
...
#| eval: true
#| echo: false
system("cp files/figures/read_length_before_pseudo_BCS_28.png include/figures/read_length_before_pseudo_BCS_28.png")
```
...
#| echo: false
#| eval: true
read_changes <- read.table("files/tables/BCS_28_read_changes.txt",
                       header = TRUE, sep = "\t")
names(read_changes)[1] <- "SampleID"

read_changes$per_reads_kept <- round(read_changes$merged/read_changes$input, 
                                  digits = 3)
write_delim(read_changes, "include/tables/BCS_28_read_changes.txt", 
            delim = "\t")
```
...
{{< downloadthis include/tables/BCS_28_read_changes.txt dname=BCS_28_read_changes label="Download read count changes" icon=table type=info class=data-button id=BCS_28_rc_changes >}}
